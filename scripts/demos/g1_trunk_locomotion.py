...
.. code-block:: bash
    ...
    # Usage
    ./isaaclab.sh -p scripts/demos/g1_trunk_locomotion.py
...
parser = argparse.ArgumentParser(
    description="interactive demo with g1's trunk only"
)
...
from isaaclab_tasks.manager_based.locomotion.velocity.config.g1_trunk.flat_env_cfg import G1TrunkFlatEnvCfgV1_PLAY

TASK = "Isaac-Velocity-Flat-G1-trunk-Play-v0"
RL_LIBRARY = "rsl_rl"

class G1TrunkFlatDemo:
    """This class provides an interactive demo for the G1 trunk flat terrain environment.
    It loads a pre-trained checkpoint for the Isaac-Velocity-Flat-G1-trunk-Play-v0 task, trained with RSL RL
    ...
    * ESC: exit current third-person view"""
    ...
    def __init__(self):
        ...
        # create envionrment
        env_cfg = G1TrunkFlatEnvCfgV1_PLAY()
        ...
        ppo_runner.load("/home/kezhuo/qped_rl_isaaclab/IsaacLab/logs/rsl_rl/g1_flat/2025-05-25_23-54-55/model_1499.pt")
...
def main():
    demo_g1_trunk = G1TrunkFlatDemo()
    obs, _ = demo_g1_trunk.env.reset()
    while simulation_app.is_running():
        demo_g1_trunk.update_selected_object()
