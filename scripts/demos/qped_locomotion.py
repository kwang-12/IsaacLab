...
class G1TrunkFlatDemo:
    ...
    It loads a pre-trained checkpoint for the Isaac-Velocity-Flat-Qped-Play-v1 task, trained with RSL RL
    ...
    def update_selected_object(self):
        ...
        if len(selected_prim_paths) == 0:
            ...
            if len(prim_splitted_path) >= 4 and prim_splitted_path[3][0:4] == "env_":
                ...
                print("The selected prim was not a Qped robot")
